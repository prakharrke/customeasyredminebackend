...
/**
 * Servlet implementation class GetProjectIssues
 */
public class GetProjectIssues extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			JSONObject autoCompleteProjects = userSession.getEasyRedmineCommunication().getProjectIssues(projectID);
